...
See 1-start.sh for Coralogix RUM instructions
The script expects to find and use 2 environment variables:
CORALOGIX_API_KEY - your Coralogix ingestion Key
CORALOGIX_RUM_KEY - your Coralogix RUM Key

Also, set your Coralogix domain and app/subsystem values in the values.yaml file - around line 379
and set your cluster name per 1-start.sh
